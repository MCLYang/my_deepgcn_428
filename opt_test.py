...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--pretrained_model', type=str, help='path to pretrained model(default: none)', 
                            default='/media/malcolm/1E577EB53AA8D6D4/My_gcn/checkpoints/ckpts-My_gcn-res-edge-4-128-200421/My_gcn-res-edge-4-128-200421_model_best.pth')
        ...
        parser.add_argument('--gpuNum', default='0', help='use multi-gpus')
        parser.add_argument('--multi_gpus', default=False, help='use multi-gpus')
